    ...
    <footer className="bg-[#382E2E] text-white py-20 px-6 md:px-20 font-sans border-t border-white/5">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4 text-[11px] font-medium uppercase tracking-widest leading-relaxed text-white/60">
            <p>
        ...
        <div className="space-y-6">
          <h4 className="text-[10px] font-black uppercase tracking-[0.4em] text-white/30 italic">Stay Connected</h4>
          <div className="flex gap-4">
            ...
            {/* WhatsApp Icon */}
            <a href="#" className="p-3 border border-white/10 hover:bg-white hover:text-[#382E2E] transition-all duration-500 rounded-xl">
