    ...
    <nav className="fixed top-0 w-full z-[999] bg-white/90 backdrop-blur-md border-b border-zinc-100 font-sans">
      <div className="max-w-7xl mx-auto px-6 md:px-20 py-4 flex justify-between items-center">
        ...
        <Link href="/" className="flex items-center gap-2">
          <div className="p-1">
            <Image src="/foto/logo-nobg.png" alt="Logo" width={50} height={50} priority />
          </div>
        ...
        {/* DESKTOP MENU */}
        <div className="hidden md:flex gap-10 text-[10px] font-black uppercase tracking-widest items-center text-[#382E2E]">
          ...
          <Link href="/reservasi" className="bg-[#382E2E] text-white px-6 py-3 rounded-xs hover:bg-[#cbc500] hover:text-[#382E2E] transition-all shadow-xl shadow-zinc-200">
            Reservasi
          </Link>
        </div>
