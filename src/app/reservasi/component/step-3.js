  ...
  return (
    <main className="max-w-6xl mx-auto px-2 md:px-4 py-8 pb-32">
      ...
      <div className="text-center mb-10">
        <h2 className="text-3xl font-black text-[#382E2E] uppercase tracking-tighter">Daftar Menu</h2>
            ...
            <div className="p-2.5 md:p-5 flex flex-col flex-1">
              ...
              <div className="mt-auto flex justify-end">
                <button
                  ...
                  className="w-11 bg-[#f3f0e1] hover:bg-[#382E2E] hover:text-[#cbc500] text-[#382E2E] py-2 md:py-3 rounded-full flex items-center justify-center transition-all shadow-sm"
                >
