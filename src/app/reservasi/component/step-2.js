    ...
    <main>
        ...
        <div className="bg-white p-6 md:p-8 rounded-lg border border-gray-100 shadow-xl">
            ...
            <div className="w-full">
                <label className="block text-sm font-medium mb-2 text-[#382E2E] tracking-wider">Nama Pemesan</label>
            ...
            <div className="w-full">
                <label className="block text-sm font-medium mb-2 text-[#382E2E] tracking-wider">Nomor WhatsApp</label>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div>
                <label className="block text-sm font-medium mb-2 text-[#382E2E] tracking-wider">Tanggal</label>
                <input type="date" className="w-full px-5 py-4 rounded-2xl bg-gray-50 border-none focus:ring-2 focus:ring-[#cbc500]" />
                </div>
                <div>
                <label className="block text-sm font-medium mb-2 text-[#382E2E] tracking-wider">Jam Datang</label>
                <input type="time" className="w-full px-5 py-4 rounded-2xl bg-gray-50 border-none focus:ring-2 focus:ring-[#cbc500]" />
                </div>
                <div>
                <label className="block text-sm font-medium mb-2 text-[#382E2E] tracking-wider">Jam Keluar</label>
                <input type="time" className="w-full px-5 py-4 rounded-2xl bg-gray-50 border-none focus:ring-2 focus:ring-[#cbc500]" />
                </div>
            </div>

            <div className="w-full">
                <label className="block text-sm font-medium mb-2 text-[#382E2E] tracking-wider">Jumlah Orang</label>
        ...
        {/* NAVIGASI - MOBILE FRIENDLY */}
            ...
            <button className="text-sm font-medium text-gray-400 tracking-widest hover:text-[#382E2E] transition-colors">
                Kembali
            </button>

            {/* Tombol Lanjut (Ukurannya dipasin buat jempol) */}
            <button className="font-medium bg-[#382E2E] text-[#cbc500] px-8 py-2.5 rounded-full text-md shadow-md active:scale-95 transition-all tracking-tighter">
                Lanjut 
            </button>
            </div>
        </div>
