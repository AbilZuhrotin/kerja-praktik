      ...
      <main className="pt-20">
        ...
        <section className="h-[80vh] flex items-center px-6 md:px-20 bg-[#382E2E] text-white relative overflow-hidden">
          <div className="z-10">
            ...
            <p className="max-w-md text-[10px] font-bold uppercase tracking-[0.3em] opacity-50 mb-10 leading-loose">
        ...
        <section className="py-24 px-6 md:px-20 grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-6">
            <h2 className="text-4xl font-black uppercase tracking-tighter border-l-4 border-[#cbc500] pl-6">
              The Story.
            </h2>
          ...
          <div className="aspect-square bg-zinc-100 relative overflow-hidden rounded-2xl border border-zinc-100">
            <Image
        ...
        <section className="py-24 px-6 md:px-20 text-center">
          <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
            ...
            <a
              ...
              target="_blank"
              className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest border-2 border-[#382E2E] px-6 py-3 hover:bg-[#382E2E] hover:text-white transition-all"
            >
        ...
        <section className="py-24 bg-[#382E2E] text-white px-6 md:px-20 overflow-hidden relative">
          <div className="text-left mb-16 border-l-4 border-[#cbc500] pl-6">
            <h2 className="text-[10px] font-black uppercase tracking-[0.5em] text-zinc-300 mb-2">Testimonials</h2>
            <h3 className="text-4xl font-black uppercase tracking-tighter text-[#cbc500]">What They Say.</h3>
          </div>
        ...
        <section className="py-24 px-6 md:px-20 grid md:grid-cols-2 gap-16 items-center">
          <div className="space-y-10">
            ...
            <div className="space-y-4 border-l-2 border-zinc-100 pl-8">
              ...
              <p className="text-sm font-black">09:00 — 00:00</p>
            </div>
            <a
              ...
              target="_blank"
              className="inline-block bg-[#382E2E] text-white px-8 py-4 text-[10px] font-bold tracking-widest rounded-xs hover:bg-black transition-all"
            >
              Buka di Google Maps
            </a>
          </div>
